...
export interface IRemoteConfigTemplate {
    ...
    parameters?: {
        [key: string]: IRemoteConfigParameter;
    };
    parameterGroups?: {
        [key: string]: IRemoteConfigParameterGroup;
    };
...
export interface IRemoteConfigParameter {
    ...
    conditionalValues?: {
        [key: string]: IRemoteConfigParameterValue;
    };
    description?: string;
...
export type FirebaseResource = 'realtimeDatabase' | 'firestore' | 'auth' | 'messaging' | 'remoteConfig' | 'dynamicLinks' | 'storage';
export type RealtimeDatabaseOperation = 'read' | 'write' | 'update' | 'push' | 'delete' | 'query';
export type FirestoreOperation = 'createDocument' | 'getDocument' | 'listDocuments' | 'updateDocument' | 'deleteDocument' | 'query' | 'batchWrite' | 'runTransaction';
export type AuthOperation = 'createUser' | 'getUser' | 'getUserByEmail' | 'listUsers' | 'updateUser' | 'deleteUser' | 'generatePasswordResetLink' | 'generateEmailVerificationLink' | 'setCustomClaims' | 'revokeRefreshTokens';
export type MessagingOperation = 'sendMessage' | 'sendMulticast' | 'sendToTopic' | 'sendToCondition' | 'subscribeToTopic' | 'unsubscribeFromTopic';
export type RemoteConfigOperation = 'getTemplate' | 'publishTemplate' | 'rollback' | 'listVersions' | 'getConditions' | 'getParameters';
export type DynamicLinksOperation = 'createShortLink' | 'getLinkStats';
export type StorageOperation = 'upload' | 'download' | 'delete' | 'getMetadata' | 'updateMetadata' | 'listFiles';
//# sourceMappingURL=FirebaseTypes.d.ts.map