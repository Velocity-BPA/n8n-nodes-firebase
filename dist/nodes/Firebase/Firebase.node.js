...
const realtimeDatabase = __importStar(require("./actions/realtimeDatabase"));
const firestore = __importStar(require("./actions/firestore"));
const auth = __importStar(require("./actions/auth"));
const messaging = __importStar(require("./actions/messaging"));
const remoteConfig = __importStar(require("./actions/remoteConfig"));
const dynamicLinks = __importStar(require("./actions/dynamicLinks"));
const storage = __importStar(require("./actions/storage"));
