	...
	describe('URL Construction', () => {
		...
		it('should construct Firestore URLs correctly', () => {
			...
			expect(expectedUrl).toBe(
				'https://firestore.googleapis.com/v1/projects/test-project/databases/(default)/documents/users/123',
			);
		});
		...
		it('should construct Remote Config URLs correctly', () => {
			...
			expect(expectedUrl).toBe(
				'https://firebaseremoteconfig.googleapis.com/v1/projects/test-project/remoteConfig:listVersions',
			);
		});
		...
		it('should construct Storage URLs correctly', () => {
			...
			expect(expectedUrl).toBe(
				'https://storage.googleapis.com/storage/v1/b/test-project.appspot.com/o/path%2Fto%2Ffile.txt',
			);
		});
