...
export class FirebaseApi implements ICredentialType {
  name = 'firebaseApi';
  ...
  properties: INodeProperties[] = [
    ...
    },
    {
      ...
      required: true,
      description:
        'The private key from the service account JSON file. Include the full key with BEGIN/END markers.',
    ...
    },
    {
      ...
      default: '',
      description:
        'The Realtime Database URL (required for Realtime Database operations). Format: https://[PROJECT_ID].firebaseio.com or https://[PROJECT_ID]-default-rtdb.firebaseio.com',
    ...
    },
    {
      ...
      default: '',
      description:
        'The Cloud Storage bucket name (required for Storage operations). Format: [PROJECT_ID].appspot.com',
